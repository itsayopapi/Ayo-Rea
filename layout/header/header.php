        ...
        <div class="row">
            <div class="rts-header__wrapper">
                ...
                <nav class="rts-header__menu" id="mobile-menu">
                    <div class="hostie-menu">
                        <ul class="list-unstyled hostie-desktop-menu">
                            ...
                            <li class="menu-item hostie-has-dropdown">
                                <a href="#" class="hostie-dropdown-main-element">Blog</a>
                                <ul class="hostie-submenu list-unstyled menu-pages">
                                    <li class="nav-item"><a class="nav-link" href="/blog">Blog</a></li>
                                    <li class="nav-item"><a class="nav-link" href="/blog-details">Blog Details</a></li>
                                    <li class="nav-item"><a class="nav-link" href="/blog-grid">Blog Grid</a></li>
                                    <li class="nav-item"><a class="nav-link" href="/blog-list">Blog List</a></li>
                                </ul>
                            </li>
                ...
                <div class="rts-header__right">
                    <a href="https://my.wefithost.com/login" class="login__btn">Login</a>
                    <a href="https://my.wefithost.com/manage" class="getstarted__btn">Get Started</a>
