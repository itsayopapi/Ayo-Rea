            ...
            <div class="row justify-content-center">
                <div class="col-lg-5 col-xl-6 col-md-10">
                    <div class="support-feature-image">
                        <img src="assets/images/feature/support__feature__two.jpg" width="645" height="477" alt="">
                    </div>
                </div>
    ...
    <div class="rts-support-feature section__padding cloud__feature">
        <div class="container">
            <div class="row justify-content-center align-items-center">
                <div class="col-lg-5 col-xl-6 col-md-10">
                    <div class="support-feature-image">
                        <img src="assets/images/feature/feature__image__three.png" alt="">
                    </div>
                </div>
                <div class="col-xl-6 col-lg-7 col-md-10">
                    <div class="support-feature__content">
