            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="rts-hero__content domain">
                        <h1 data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">Register Your Perfect Domain Name
                        </h1>
                        <p class="description" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">Buy domain names with the best prices around. Pay the same low, all-inclusive prices every year, with great discounts available.</p>
                        ...
                        <div class="banner-content-tag" data-sal-delay="400" data-sal-duration="800">
                            ...
                            <ul class="tag-list">
                                <li><span>.co.uk</span><span>$5.99</span></li>
                                <li><span>.com</span><span>$11.49</span></li>
                                <li><span>.net</span><span>$11.49</span></li>
                                <li><span>.info</span><span>$12.99</span></li>
                                <li><span>.xyz</span><span>$1.99</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-hover table-responsive">
                            ...
                            <tbody class="table__content">
                                <tr>
                                    ...
                                    <td class="process">$11.49</td>
                                    <td class="ram">$17.99</td>
                                    <td class="storage">$9.99</td>
                                </tr>
                                <tr>
                                    <td class="package">.net</td>
                                    <td class="process">$11.99</td>
                                    <td class="ram">$11.99</td>
                                    <td class="storage">$9.99</td>
                                </tr>
                                <tr>
                                    <td class="package">.online</td>
                                    <td class="process">$29.00</td>
                                    <td class="ram">$29.00</td>
                                    <td class="storage">$9.99</td>
                                </tr>
                                <tr>
                                    <td class="package">.shop</td>
                                    <td class="process">$27.49</td>
                                    <td class="ram">$27.49</td>
                                    <td class="storage">$9.99</td>
                                </tr>
                                <tr>
                ...
                <div class="rts-section section-style-two">
                    <div class="rts-section__two">
                        <h2 class="title mb-0" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">Why
                            Chooses WefitHost</h2>
                    </div>
                    <div class="rts-section-description">
                        <p class="description w-400" data-sal="slide-left" data-sal-delay="200" data-sal-duration="800">
                            We believe you should be able to control how much of your personal information is shared online.
                            Our WHOIS Domain Privacy is included at NO COST (for the life of your domain) and will renew automatically.</p>
                    </div>
                </div>
            </div>
            <!-- why choose feature -->
                ...
                <div class="col-lg-3 col-sm-6" data-sal="slide-down" data-sal-delay="400" data-sal-duration="800">
                    <div class="card-feature">
                        <div class="card-feature__single">
                            ...
                            <p class="card-feature__single--description">
                                Securing a domain related to your business prevents others from using it and capitalising on your hard work.
                                It also offers some level of protection for your brand’s identity.
                            </p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="accordion-item active">
                                ...
                                <div id="item__one" class="accordion-collapse collapse collapse show" aria-labelledby="first" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        ...
                                        buy a domain name from wefithost, we guarantee it will be handed over.
                                    </div>
                                </div>
                            </div>
