                ...
                <div class="banner-area">
                    <div class="rts-hosting-banner rts-hosting-banner__content resell__banner">
                        ...
                        <div class="hosting-action" data-sal="slide-down" data-sal-delay="400" data-sal-duration="800">
                            <a href="http://my.wefithost.com" class="btn__two secondary__bg secondary__color">View Plan <i class="fa-regular fa-arrow-right"></i></a>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="hosting-info">
                        ...
                        <a href="http://my.wefithost.com" class="btn__two btn__long secondary__bg secondary__color">View Plan <i class="fa-regular fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="rts-pricing-plan alice__blue section__padding">
        <div class="container">
                    ...
                    <div class="row g-30 monthly">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan active">
                                ...
                                <div class="card-plan__cartbtn">
                                    <a href="http://my.wefithost.com/mange">Sign Up Now</a>
                                </div>
                                <p class="card-plan__renew-price">
                                    $ 6.99 /mo when you renew
                                </p>
            ...
            <div class="view-plan-btn">
                <a href="/pricing" class="btn long-btn">view all plan</a>
            </div>
        </div>
    </div>
