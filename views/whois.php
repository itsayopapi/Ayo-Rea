            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="rts-hero__content domain">
                        ...
                        <form action="" class="domain-form d-flex gap-2">
                ...
                <div class="col-lg-4 col-md-6 col-sm-10">
                    <div class="feature__card">
                        <div class="feature__card--content">
                            ...
                            <p class="description">
                                Wefithost WHOIS search tool helps you check
                ...
                <div class="result-content">
                    <div class="result-content__left">
                        <h2 class="result-title fw-bold">What Is the WHOIS
                            Lookup Tool?</h2>
                        <p>Wefithost WHOIS lookup tool shows the latest data registered
                        ...
                        <div class="accordion accordion-flush" id="rts-accordion">
                            <div class="accordion-item active">
                                ...
                                <div id="item__one" class="accordion-collapse collapse collapse show" aria-labelledby="first" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        WHOIS is a public database that provides information about domain name registrations, including the owner, registrar, and expiration date.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="item__two" class="accordion-collapse collapse" aria-labelledby="two" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        You can use our WHOIS lookup tool to check domain ownership details by entering the domain name in the search bar.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="item__two" class="accordion-collapse collapse" aria-labelledby="two" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        WHOIS data is updated whenever a domain’s ownership or registration details change, typically within 24-48 hours.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="item__three" class="accordion-collapse collapse" aria-labelledby="three" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        Yes, you can enable WHOIS privacy protection to keep your personal details hidden from public view.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <div class="accordion-header" id="four">
                                    <h4 class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#item__four" aria-expanded="false" aria-controls="item__four">
                                        Why is my domain information visible in WHOIS?
                                    </h4>
                                </div>
                                <div id="item__four" class="accordion-collapse collapse" aria-labelledby="four" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        Domain registration details are publicly available unless you enable WHOIS privacy protection through your domain registrar.
                                </div>
                                </div>
                                </div>
                            </div>
