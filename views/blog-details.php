                ...
                <div class="banner-area">
                    <div class="rts-hosting-banner rts-hosting-banner__content blog__banner">
                        ...
                        <div class="hosting-action">
                            <a href="/blog.details" class="btn__two secondary__bg secondary__color">View Details <i class="fa-regular fa-arrow-right"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="rts-sidebar">
                        ...
                        <div class="rts-single-widget category-widget">
                            ...
                            <ul class="list-unstyled cat__counter">
                                <li class="single-cat">
                                    <a href="#">Web Hosting <span><i class="fa-regular fa-arrow-right"></i></span></a>
                                </li>
                                <li class="single-cat">
                                    <a href="#">WordPress Hosting <span><i class="fa-regular fa-arrow-right"></i></span></a>
                                </li>
                                <li class="single-cat">
                                    <a href="#">VPS Hosting <span><i class="fa-regular fa-arrow-right"></i></span></a>
                                </li>
                                <li class="single-cat">
                                    <a href="#">SSL Certificate <span><i class="fa-regular fa-arrow-right"></i></span></a>
                                </li>
                                <li class="single-cat">
                                    <a href="#">Managed Cloud Hosting <span><i class="fa-regular fa-arrow-right"></i></span></a>
                                </li>
                                <li class="single-cat">
