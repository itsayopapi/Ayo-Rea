            ...
            <div class="row">
                <div class="banner-area">
                    <div class="rts-hosting-banner rts-hosting-banner__content about__banner">
                        <span class="starting__price" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">About WefitHost</span>
                        ...
                        <div class="hosting-action" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">
                            <a href="https://www.my.wefithost.com/" class="btn__two secondary__bg secondary__color">View Plan <i class="fa-regular fa-arrow-right"></i></a>
                            <a href="/pricing" class="btn__white">Starting @ $1.89/mo</a>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="hosting-info">
                        <h3 class="hosting-info__title" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">About WefitHost</h3>
                        <p class="description" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">At Wefithost, we don’t just deploy and manage cutting-edge hosting platforms—we redefine industry standards. With innovation, reliability, and unmatched performance, we are committed to leading the hosting industry and delivering the best solutions for our customers</p>
                        ...
                        <a href="" class="btn__two btn__long secondary__bg secondary__color">View Plan <i class="fa-regular fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="hosting-info w-550 mt-md-0">
                        <h2 class="hosting-info__title" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">Digital Lovers</h2>
                        <p class="description" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">Excellence is at the core of everything we do. More than just a hosting provider, we are your all-in-one digital partner. From seamless website design and development to reliable maintenance and support, we ensure your online success every step of the way</p>
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">Wefithost has been a game-changer for my business! The uptime is impeccable, and the website speed has drastically improved since switching to their hosting. Their customer support team is always ready to assist, making the entire experience smooth and stress-free. Highly recommended!</p>
                                    <div class="feedback-card__single--author">
                                        <div class="author">
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">I was searching for an affordable hosting solution that didn’t compromise on performance, and Wefithost delivered beyond my expectations. The plans are budget-friendly, and the features are top-notch. I love the user-friendly dashboard and seamless WordPress integration!</p>
                                    <div class="feedback-card__single--author">
                                        <div class="author">
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">Security and speed were my top concerns when choosing a hosting provider, and Wefithost excels in both. Their advanced security measures keep my site safe, and the loading times are blazing fast. It’s the perfect hosting solution for businesses and bloggers alike!</p>
                                    <div class="feedback-card__single--author">
                                        <div class="author">
