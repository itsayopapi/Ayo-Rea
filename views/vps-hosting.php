            ...
            <div class="row justify-content-sm-center">
                <div class="banner-area">
                    <div class="rts-hosting-banner rts-hosting-banner__content">
                        ...
                        <p class="slogan" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">Expect More From Your Server Performance.</p>
                ...
                <div class="col-lg-6">
                    <div class="rts-feature-section">
                        <h2 class="title" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">
                            Get complete control and flexibility with our high-performance VPS solutions
                        </h2>
                        <p data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">
                           Our VPS hosting solutions give you the power and flexibility to manage your own server environment. Whether you need to host a high-traffic website, run a demanding application, or manage a complex network, our VPS can handle it all.</p>
                    </div>
                </div>
                    ...
                    <div class="card-feature">
                        <div class="card-feature__single">
                            ...
                            <p class="card-feature__single--description">
                                Our servers are protected by a variety of security measures, including firewalls, intrusion detection systems, and DDoS protection.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6" data-sal="slide-down" data-sal-delay="400" data-sal-duration="800">
                    <div class="card-feature">
                        <div class="card-feature__single">
                            ...
                            <p class="card-feature__single--description">
                                Our VPS plans come with scalable RAM and storage, delivering optimal speed, reliability, and efficiency.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6" data-sal="slide-down" data-sal-delay="500" data-sal-duration="800">
                    <div class="card-feature">
                        <div class="card-feature__single">
                            ...
                            <p class="card-feature__single--description">
                                Set up your virtual server in minutes with instant deployment, an intuitive control panel, and smooth management.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6" data-sal="slide-down" data-sal-delay="600" data-sal-duration="800">
                    <div class="card-feature">
                        <div class="card-feature__single">
                            ...
                            <p class="card-feature__single--description">
                                Enjoy unrestricted data transfer with high-speed connectivity, ensuring stable performance for all workloads.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6" data-sal="slide-down" data-sal-delay="700" data-sal-duration="800">
                    <div class="card-feature">
                        <div class="card-feature__single">
                            ...
                            <p class="card-feature__single--description">
                                Get ultra-fast SSD storage, professional email services, and free SSL certificates for enhanced security.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6" data-sal="slide-down" data-sal-delay="800" data-sal-duration="800">
                    <div class="card-feature">
                        <div class="card-feature__single">
                            ...
                            <p class="card-feature__single--description">
                                Run dynamic applications with full support for PHP7, Perl, and Python, ensuring smooth and efficient development.
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan">
                                <div class="card-plan__package">
                                    ...
                                    <h4 class="package__name">1 Core Basic</h4>
                                </div>
                                <p class="card-plan__desc">Perfect for beginners! Affordable 1-core cloud hosting with everything you need to launch your site.

</p>
                                <div class="card-plan__offer">
                                    <span class="past-price">$16.63</span>
                                ...
                                <div class="card-plan__feature">
                                    <ul class="card-plan__feature--list">
                                        ...
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-xmark"></i> 60 GB SSD Storage</span>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan">
                                <div class="card-plan__package">
                                    ...
                                    <h4 class="package__name">2 Core Basic</h4>
                                </div>
                                <p class="card-plan__desc">Perfect for beginners! Affordable 2-core cloud hosting with everything you need to launch your site.


</p>
                                <div class="card-plan__offer">
                                    <span class="past-price">$22.63</span>
                                    <span class="offer-given">Save 60%</span>
                                </div>
                                <h5 class="card-plan__price">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan active">
                                ...
                                <div class="card-plan__package">
                                    ...
                                    <h4 class="package__name">3 Core Business</h4>
                                </div>
                                <p class="card-plan__desc">Perfect for beginners! Affordable 3-core cloud hosting with everything you need to launch your site.</p>
                                <div class="card-plan__offer">
                                    <span class="past-price">$49.63</span>
                                    <span class="offer-given">Save 60%</span>
                                </div>
                                <h5 class="card-plan__price">
                                    <sup>$</sup> 30.89 <sub>/ month</sub>
                                </h5>
                                <div class="card-plan__cartbtn">
                                    <a href="https://my.wefithost.com/manage">Sign Up Now</a>
                                </div>
                                <p class="card-plan__renew-price">
                                    $ 30.89 /mo when you renew
                                </p>                                <div class="card-plan__feature">
                                    <ul class="card-plan__feature--list">
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> 1 Website</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="Explore, discover, and learn on our innovative and informative website."><i class="fa-light fa-circle-question"></i></span>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan ">
                                ...
                                <div class="card-plan__package">
                                    ...
                                    <h4 class="package__name"> 5 Core Startup</h4>
                                </div>
                                <p class="card-plan__desc">Powerful 5-core cloud hosting with enhanced performance and scalability to support your success.</p>
                                <div class="card-plan__offer">
                                    <span class="past-price">$69.63</span>
                                    <span class="offer-given">Save 60%</span>
                                </div>
                                <h5 class="card-plan__price">
                                    <sup>$</sup> 59.08 <sub>/ month</sub>
                                </h5>
                                <div class="card-plan__cartbtn">
                                    <a href="https://my.wefithost.com/manage">Sign Up Now</a>
                                </div>
                                <p class="card-plan__renew-price">
                                    $ 59.08 /mo when you renew
                                </p>
                                <div class="card-plan__feature">
                                    <ul class="card-plan__feature--list">
                                        <li class="card-plan__feature--list-item">
            ...
            <div class="row align-items-center gy-30">
                <div class="col-lg-4 col-xl-5 col-md-12 d-lg-block d-md-flex gap-md-3 justify-content-md-center">
                    <div class="rts-section-content">
                        <h2 class="title" data-sal="slide-down" data-sal-delay="100" data-sal-duration="800">
                            Get More Power, Choose WeFitHost VPS.
                        </h2>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="rts-section w-500 text-center">
                    ...
                    <p class="rts-section__description" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">We’re proud to share the amazing feedback we receive from our clients, who inspire us to continually improve and deliver the best service possible.
                    </p>
                </div>
            </div>
            <!-- client feedback -->
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">WeFitHost has been a game-changer for my business. The VPS performance is top-notch, and their support team is always quick to respond when I need help. Highly recommended!.</p>
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">The uptime and speed I get with WeFitHost’s VPS are incredible. It’s made managing my website so much easier. I couldn’t ask for a better hosting provider.</p>
                                    <div class="feedback-card__single--author">
                                        <div class="author">
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">WeFitHost has exceeded all my expectations. My website loads faster, and the VPS gives me the flexibility I need to scale as my business grows.</p>
                                    <div class="feedback-card__single--author">
                                        <div class="author">
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">I’ve been using WeFitHost for over a year now, and I’m beyond satisfied. Their VPS plans offer great value, and the customer service is second to none.</p>
                                    <div class="feedback-card__single--author">
                                        <div class="author">
                        ...
                        <div class="accordion accordion-flush" id="rts-accordion">
                            <div class="accordion-item active">
                                ...
                                <div id="item__one" class="accordion-collapse collapse collapse show" aria-labelledby="first" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        VPS (Virtual Private Server) hosting is a type of web hosting where your website is hosted on a virtual machine that mimics a dedicated server but shares physical resources with others.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="item__two" class="accordion-collapse collapse" aria-labelledby="two" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                       Unlike shared hosting, where resources are shared with many users, VPS gives you dedicated resources (CPU, RAM, storage) within a virtualized environment.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="item__three" class="accordion-collapse collapse" aria-labelledby="three" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        While VPS gives you more control, it may require some technical expertise, especially if you want to configure the server. However, many providers offer managed services to assist you.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="item__four" class="accordion-collapse collapse" aria-labelledby="four" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        Yes, you can easily upgrade your VPS plan to meet growing demands for more resources like RAM, storage, and bandwidth.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="item__five" class="accordion-collapse collapse" aria-labelledby="five" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        Yes, VPS hosting is secure. It provides better isolation compared to shared hosting, and many VPS providers offer additional security features like firewalls, DDoS protection, and monitoring.
                                    </div>
                                </div>
                            </div>
