...
<body class="page-template template-resell">
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="rts-hero__content domain">
                        ...
                        <p class="description" data-sal="slide-down" data-sal-delay="200" data-sal-duration="800">Enter the domain that you would like to transfer to Wefithost</p>
    ...
    <!-- WEFITHOST SECURITY ANNOUNCEMENT SECTION -->
    ...
    <!-- WEFITHOST SECURITY ANNOUNCEMENT SECTION END -->
                        ...
                        <div class="accordion accordion-flush" id="rts-accordion">
                            <div class="accordion-item active">
                                ...
                                <div id="item__one" class="accordion-collapse collapse collapse show" aria-labelledby="first" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        A domain name is your website’s unique address on the internet (e.g., yourwebsite.com). It helps customers find you online and builds your brand identity.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="item__two" class="accordion-collapse collapse" aria-labelledby="two" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        Simply search for your desired domain on our platform, choose an available name, select a plan, and complete the registration process.
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="item__three" class="accordion-collapse collapse" aria-labelledby="three" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        Yes! You can transfer your existing domain to WeFitHost easily. Just ensure your domain is unlocked, and you have the transfer authorization code from your current provider.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <div class="accordion-header" id="four">
                                    <h4 class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#item__four" aria-expanded="false" aria-controls="item__four">
                                        WWhat happens if my domain expires?
                                    </h4>
                                </div>
                                <div id="item__four" class="accordion-collapse collapse" aria-labelledby="four" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        If your domain expires, it enters a grace period where you can renew it. After this period, it may become available for others to purchase, so timely renewal is crucial.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="item__five" class="accordion-collapse collapse" aria-labelledby="five" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        Yes, WeFitHost offers domain privacy protection to keep your personal information safe from spammers and scammers.
                                    </div>
                                </div>
                            </div>
