                ...
                <div class="banner-area">
                    <div class="rts-hosting-banner rts-hosting-banner__content w-550">
                        ...
                        <div class="hosting-action">
                            <a href="http://my.wefithost.com" class="btn__two secondary__bg secondary__color">Start Now <i class="fa-regular fa-arrow-right"></i></a>
                        </div>
                    </div>
    ...
    <div class="rts-pricing-plan alice__blue section__padding">
        <div class="container">
                    ...
                    <div class="row g-30 monthly">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan">
                                <div class="card-plan__package">
                                    ...
                                    <h4 class="package__name">GeoTrust</h4>
                                </div>
                                <p class="card-plan__desc">Simple SSL</p>
                                <div class="card-plan__offer">
                                    <span class="past-price">$49.31</span>
                                    <span class="offer-given">Save 60%</span>
                                </div>
                                <h5 class="card-plan__price">
                                    <sup>$</sup> 49.31 <sub>/ yearly</sub>
                                </h5>
                                <div class="card-plan__cartbtn">
                                    <a href="http://my.wefithost.com/manage">Sign Up Now</a>
                                </div>
                                <p class="card-plan__renew-price">
                                    $ 49.31 yearly when you renew
                                </p>
                                <div class="card-plan__feature">
                                    <ul class="card-plan__feature--list">
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> SSL Certificates from GeoTrust</span>
                                        ...
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> Simple SSL</span>
                                        ...
                                        <li class="card-plan__feature--list-item">
                                            ...
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" title="WeFitHost     provides reliable 24/7 support for your hosting needs, ensuring assistance whenever you require help."><i class="fa-light fa-circle-question"></i></span>
                                        </li>
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> Improve Google Ranking</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" title="WeFitHost     offers complimentary email services, empowering your online communication with reliable and secure free email solutions."><i class="fa-light fa-circle-question"></i></span>
                                        </li>
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> Padlock icon for your site visitors</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" title="WeFitHost     provides unlimited bandwidth, ensuring seamless data transfer for your website's optimal performance and user experience."><i class="fa-light fa-circle-question"></i></span>
                                        </li>
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> $10,000 Warranty</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom"
                                            title="Elevate your online presence with WeFitHost    , offering unlimited bandwidth for your domain, ensuring optimal performance and seamless data flow."><i class="fa-light fa-circle-question"></i></span>
                                        </li>


                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> Domain Validation (DV) Certificate</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Secure your website with WeFitHost    's unlimited free SSL certificates, ensuring encrypted and safe online transactions for your users."><i class="fa-light fa-circle-question"></i></span>
                                        </li>
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> 99.9% Uptime Guarantee</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" title="WeFitHost     guarantees 99% uptime, ensuring your website is consistently available and reliable for visitors around the clock."><i class="fa-light fa-circle-question"></i></span>
                                        </li>
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> Ideal for Ecommrce Site</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Enhance your website's security with WeFitHost    's Web Application Firewall, protecting against online threats and ensuring a safe online environment."><i class="fa-light fa-circle-question"></i></span>
                                        </li>
                                    ...
                                    <ul class="card-plan__feature--list more__feature">
                                        <li class="card-plan__feature--list-item">
                                            ...
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" title="WeFitHost     offers generous hosting with 100GB SSD storage, providing ample space for your data and ensuring high-performance storage solutions."><i class="fa-light fa-circle-question"></i></span>
                                        </li>
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> Unlimited Websites @ your Domain</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Secure your website with WeFitHost    's unlimited free SSL certificates, ensuring encrypted and safe online transactions for your users."><i class="fa-light fa-circle-question"></i></span>
                                        </li>
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> 99.9% Uptime Guarantee</span>
                                        ...
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> Built-in Traffic Analytics</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Enhance your website's security with WeFitHost    's Web Application Firewall, protecting against online threats and ensuring a safe online environment."><i class="fa-light fa-circle-question"></i></span>
                                        </li>
                                        <li class="card-plan__feature--list-trigered">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan">
                                <div class="card-plan__package">
                                    ...
                                    <h4 class="package__name">GeoTrust Rapid SSL Wildcard</h4>
                                </div>
                                <p class="card-plan__desc">SSL Wildcard</p>
                                <div class="card-plan__offer">
                                    <span class="past-price">$127.61</span>
                                    <span class="offer-given">Save 60%</span>
                                </div>
                                <h5 class="card-plan__price">
                                    <sup>$</sup> 127.61 <sub>/ yearly</sub>
                                </h5>
                                <div class="card-plan__cartbtn">
                                    <a href="http://my.wefithost.com/manage">Sign Up Now</a>
                                </div>
                                <p class="card-plan__renew-price">
                                    $ 127.61 /yearly when you renew
                                </p>
                                <div class="card-plan__feature">
                                    <ul class="card-plan__feature--list">
                                        <li class="card-plan__feature--list-item">
                                        ...
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> Domain Vlidation(DV) Certificate</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Secure your website with WeFitHost    's unlimited free SSL certificates, ensuring encrypted and safe online transactions for your users."><i class="fa-light fa-circle-question"></i></span>
                                        </li>
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> 99.9% Uptime Guarantee</span>
                                    ...
                                    <ul class="card-plan__feature--list more__feature">
                                        ...
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-xmark"></i> Unlimited Free SSL</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Secure your website with WeFitHost    's unlimited free SSL certificates, ensuring encrypted and safe online transactions for your users."><i class="fa-light fa-circle-question"></i></span>
                                        </li>
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> 99.9% Uptime Guarantee</span>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan active">
                                <div class="popular-tag">GeoTrust Extented SSL</div>
                                <div class="card-plan__package">
                                    <div class="icon">
                                        <img src="assets/images/pricing/business.svg" height="30" width="30" alt="">
                                    </div>
                                    <h4 class="package__name">Extented SSL Business</h4>
                                </div>
                                <p class="card-plan__desc">Everything need to your website</p>
                                <div class="card-plan__offer">
                                    <span class="past-price">$295.96</span>
                                    <span class="offer-given">Save 60%</span>
                                </div>
                                <h5 class="card-plan__price">
                                    <sup>$</sup> 295.96 <sub>/ month</sub>
                                </h5>
                                <div class="card-plan__cartbtn">
                                    <a href="http://my.wefithost.com/manage">Sign Up Now</a>
                                </div>
                                <p class="card-plan__renew-price">
                                    $ 296.96 /yearly when you renew
                                </p>
                                <div class="card-plan__feature">
                                    <ul class="card-plan__feature--list">
                                        <li class="card-plan__feature--list-item">
                                        ...
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> Business Performance</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Unlock superior online experiences with our standard performance solutions, ensuring reliability, speed, and seamless functionality for your website needs."><i class="fa-light fa-circle-question"></i></span>
                                        </li>
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> 24/7/365 Support</span>
            ...
            <div class="view-plan-btn">
                <a href="http://my.wefithost.com" class="btn long-btn">view all plan</a>
            </div>
        </div>
    </div>
    <!-- PRICING PLAN START END -->

    <!-- WeFitHost     FEATURE AREA -->
            ...
            <div class="row align-items-center justify-content-md-center g-30">
                <div class="col-lg-6">
                    <div class="affiliate-feature-content">
                        ...
                        <p class="description w-470">At WeFitHost    , our free SSL is as secure as the paid ones. We use a domain-validated certificate compliant with Payment</p>
                            ...
                            <div class="accordion-item active">
                                <div class="accordion-header" id="first">
                                    <h4 class="accordion-button collapse show" data-bs-toggle="collapse" data-bs-target="#item__one" aria-expanded="false" aria-controls="item__one">
                                        Why buy a domain name from WeFitHost    ?
                                    </h4>
                                </div>
                                <div id="item__one" class="accordion-collapse collapse collapse show" aria-labelledby="first" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        Above all else, we strive to deliver outstanding customer experiences. When you buy a domain name from WeFitHost    , we guarantee it will be handed over.
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="rts-cta-two__wrapper">
                    ...
                    <div class="cta-btn">
                        <a href="#" id="liveChatButton" class="contact__us rts-btn rts-btn-secondary">Go to Live chat Page</a>
                    </div>
                    <!-- Tawk.to Script -->
