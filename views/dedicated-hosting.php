                ...
                <div class="banner-area">
                    <div class="rts-hosting-banner rts-hosting-banner__content dedicated__banner">
                        ...
                        <div class="hosting-action">
                            <a href="/pricing" class="btn__two secondary__bg secondary__color">View Plan <i class="fa-regular fa-arrow-right"></i></a>
                            <a href="" class="btn__white">Starting @ $167.00/mo</a>
                        </div>
                    </div>
                    ...
                    <table class="table">
                        ...
                        <tbody class="table__content">
                            <tr>
                                ...
                                <td>
                                <a href="https://my.wefithost.com/manage" class="btn__two primary__btn" style="text-decoration: none;">sign up</a>
                                </td>
                            </tr>
                            <tr>
                                <td class="package">Standard 4</td>
        ...
        <div class="container">
            ...
            <div class="row gy-30 justify-content-center">
                ...
                <div class="col-xl-4 offset-xl-2 col-lg-5 offset-lg-1 col-md-12 mt--100">
                    <div class="dedicated-feature-section">                        <h3>Intuitive Management</h3>
                        <p>Real-Time Analytics – Monitor your website’s performance and traffic with real-time insights directly from your control panel.</p>
                        <div class="single-feature">
                            <div class="icon">
                                <img src="assets/images/feature/dedicated/server.svg" alt="">
                            </div>
                            <p>User-Friendly Dashboard – Manage domains, emails, and databases easily with a sleek, intuitive interface.</p>
                        </div>
                        <div class="single-feature">
                            <div class="icon">
                                <img src="assets/images/feature/dedicated/ram.svg" alt="">
                        ...
                        <div class="single-feature">
                            ...
                            <p>One-Click Installs – Install popular applications like WordPress or Joomla in just a click, no technical experience needed.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row g-30 align-items-center">
                <div class="col-lg-6">
                    <div class="rts-feature-section dedicated">
                        ...
                        <p>
                            Dedicated servers from WeFitHost deliver 
                            top-tier hardware and software to keep your site running fast and reliably 24/7.                       </p>
                    </div>
                </div>
                    ...
                    <div class="card-feature">
                        <div class="card-feature__single">
                            ...
                            <p class="card-feature__single--description">
                                Stay protected with WeFitHost’s advanced security, 
                                regular updates, and proactive monitoring for maximum website safety.                          </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="card-feature">
                        <div class="card-feature__single">
                            ...
                            <p class="card-feature__single--description">
                                Experience high-performance hosting with scalable
                                RAM and ample storage to handle all your website needs seamlessly.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="card-feature">
                        <div class="card-feature__single">
                            ...
                            <p class="card-feature__single--description">
                                Set up and manage your hosting effortlessly with WeFitHost’s 
                                quick, easy, and user-friendly platform.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="card-feature">
                        <div class="card-feature__single">
                            ...
                            <p class="card-feature__single--description">
                                Enjoy seamless performance with WeFitHost’s unlimited bandwidth, 
                                ensuring fast and reliable website access anytime.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="card-feature">
                        <div class="card-feature__single">
                            ...
                            <p class="card-feature__single--description">
                                Get ultra-fast SSD storage, 
                                professional email, and free SSL for secure and high-performance hosting with WeFitHost.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="card-feature">
                        <div class="card-feature__single">
                            ...
                            <p class="card-feature__single--description">
                                Run powerful applications with support for PHP7,
                                Perl, and Python, ensuring seamless performance and flexibility.
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">WeFitHost’s dedicated hosting has been a game-changer for my eCommerce site. The speed, reliability, and support are top-notch, and I can focus on growing my business without any technical worries.</p>
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">WeFitHost has been a reliable partner for our company. With dedicated hosting, we can scale easily, and the security measures they offer give us peace of mind. Their support team is always ready to assist.</p>
                                    <div class="feedback-card__single--author">
                                        <div class="author">
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">As a high-traffic website owner, WeFitHost’s dedicated hosting gives me the power and stability I need. The server performance is incredible, and the 24/7 support is always there when I need them.</p>
                                    <div class="feedback-card__single--author">
                                        <div class="author">
                        ...
                        <div class="swiper-slide">
                            <div class="feedback-card">
                                ...
                                <div class="feedback-card__single">
                                    ...
                                    <p class="feedback-card__single--text">I switched to WeFitHost's dedicated hosting, and it’s been amazing. The server is incredibly fast, and I haven’t experienced any downtime. Plus, the team is extremely helpful whenever I have questions.</p>
                                    <div class="feedback-card__single--author">
                                        <div class="author">
                        ...
                        <div class="accordion accordion-flush" id="rts-accordion">
                            <div class="accordion-item active">
                                ...
                                <div id="item__one" class="accordion-collapse collapse collapse show" aria-labelledby="first" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        Dedicated hosting provides an entire server exclusively for your website, ensuring maximum performance, security, and control without sharing resources with other users.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div id="item__two" class="accordion-collapse collapse" aria-labelledby="two" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        Dedicated hosting is ideal for high-traffic websites, large businesses, eCommerce stores, and applications that require superior performance and reliability.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <div class="accordion-header" id="three">
                                    <h4 class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#item__three" aria-expanded="false" aria-controls="item__three">
                                        What are the benefits of WeFitHost Dedicated Hosting?
                                    </h4>
                                </div>
                                <div id="item__three" class="accordion-collapse collapse" aria-labelledby="three" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        With WeFitHost, you get top-tier hardware, full root access, advanced security, 24/7 expert support, and 99.9% uptime for a seamless experience.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="item__four" class="accordion-collapse collapse" aria-labelledby="four" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        Yes! WeFitHost allows custom configurations, so you can choose your preferred RAM, storage, bandwidth, and software to match your needs.
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <div class="accordion-header" id="five">
                                    <h4 class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#item__five" aria-expanded="false" aria-controls="item__four">
                                        Does WeFitHost provide full root access?
                                    </h4>
                                </div>
                                <div id="item__five" class="accordion-collapse collapse" aria-labelledby="five" data-bs-parent="#rts-accordion">
                                    <div class="accordion-body">
                                        Absolutely! You get full root access to your dedicated server, giving you complete control over your hosting environment.
                                    </div>
                                </div>
                            </div>
