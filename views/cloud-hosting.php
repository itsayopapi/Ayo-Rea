                ...
                <div class="banner-area">
                    <div class="rts-hosting-banner rts-hosting-banner__content cloud__banner">
                        ...
                        <div class="hosting-action">
                            ...
                            <a href="" class="btn__white">Starting @ $12.75/mo</a>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan">
                                <div class="card-plan__package">
                                    ...
                                    <h4 class="package__name">WefitCloud20</h4>
                                </div>
                                <p class="card-plan__desc">Perfect for beginners! Affordable shared hosting with everything you need to launch your site</p>
                                <div class="card-plan__offer">
                                    <span class="past-price">$68.63</span>
                                    <span class="offer-given">Save 60%</span>
                                </div>
                                <h5 class="card-plan__price">
                                    <sup>$</sup> 68.63 <sub>/ month</sub>
                                </h5>
                                <div class="card-plan__cartbtn">
                                    <a href="https://my.wefithost.com/manage">Sign Up Now</a>
                                </div>
                                <p class="card-plan__renew-price">
                                    $ 128.99 /mo when you renew
                                </p>
                                <div class="card-plan__feature">
                                    <ul class="card-plan__feature--list">
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> 20 Website</span>
                                        ...
                                        <li class="card-plan__feature--list-item">
                                            ...
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Wefithost provides reliable 24/7 support for your hosting needs, ensuring assistance whenever you require help."><i class="fa-light fa-circle-question"></i></span>
                                        </li>
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-xmark"></i> Free Email</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Wefithost offers complimentary email services, empowering your online communication with reliable and secure free email solutions."><i class="fa-light fa-circle-question"></i></span>
                                        </li>
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-xmark"></i> Unlimited Bandwidth</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Wefithost provides unlimited bandwidth, ensuring seamless data transfer for your website's optimal performance and user experience."><i class="fa-light fa-circle-question"></i></span>
                                        </li>
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-xmark"></i> 100 GB SSD Storage</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Elevate your online presence with Wefithost, offering unlimited bandwidth for your domain, ensuring optimal performance and seamless data flow."><i class="fa-light fa-circle-question"></i></span>
                                        </li>


                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> Unlimited Free SSL</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Secure your website with Wefithost's unlimited free SSL certificates, ensuring encrypted and safe online transactions for your users."><i class="fa-light fa-circle-question"></i></span>
                                        </li>
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> 99.9% Uptime Guarantee</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Wefithost guarantees 99% uptime, ensuring your website is consistently available and reliable for visitors around the clock."><i class="fa-light fa-circle-question"></i></span>
                                        </li>
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-xmark"></i> Web Application Firewall</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Enhance your website's security with Wefithost's Web Application Firewall, protecting against online threats and ensuring a safe online environment."><i class="fa-light fa-circle-question"></i></span>
                                        </li>
                                    ...
                                    <ul class="card-plan__feature--list more__feature">
                                        <li class="card-plan__feature--list-item">
                                            ...
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Wefithost offers generous hosting with 100GB SSD storage, providing ample space for your data and ensuring high-performance storage solutions."><i class="fa-light fa-circle-question"></i></span>
                                        </li>
                                        <li class="card-plan__feature--list-item">
                                            <span class="text"><i class="fa-regular fa-check"></i> Unlimited Free SSL</span>
                                            <span class="tolltip" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-original-title="Secure your website with Wefithost's unlimited free SSL certificates, ensuring encrypted and safe online transactions for your users."><i class="fa-light fa-circle-question"></i></span>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan">
                                <div class="card-plan__package">
                                    ...
                                    <h4 class="package__name">WefitCloud50</h4>
                                </div>
                                <p class="card-plan__desc">Ideal for multiple sites and custom email hosting, including seamless WordPress support</p>
                                <div class="card-plan__offer">
                                    <span class="past-price">$72.18</span>
                                    <span class="offer-given">Save 60%</span>
                                </div>
                                <h5 class="card-plan__price">
                                    <sup>$</sup> 72.18 <sub>/ month</sub>
                                </h5>
                                <div class="card-plan__cartbtn">
                                    <a href="https://my.wefithost.com/manage">Sign Up Now</a>
                                </div>
                                <p class="card-plan__renew-price">
                                    $ 188.99 /mo when you renew
                                </p>
                                <div class="card-plan__feature">
                                    <ul class="card-plan__feature--list">
                                        <li class="card-plan__feature--list-item">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan active">
                                ...
                                <div class="card-plan__package">
                                    ...
                                    <h4 class="package__name"> Wefit 5Core Startup</h4>
                                </div>
                                <p class="card-plan__desc">Perfect for hosting multiple websites and professional email @ your domain with ease


</p>
                                <div class="card-plan__offer">
                                    <span class="past-price">$59.99</span>
                                    <span class="offer-given">Save 60%</span>
                                </div>
                                <h5 class="card-plan__price">
                                    <sup>$</sup> 59.99 <sub>/ month</sub>
                                </h5>
                                <div class="card-plan__cartbtn">
                                    <a href="https://my.wefithost.com/manage">Sign Up Now</a>
                                </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card-plan ">
                                ...
                                <div class="card-plan__package">
                                    ...
                                    <h4 class="package__name">Wefit Small Team 200</h4>
                                </div>
                                <p class="card-plan__desc">Perfect for dynamic cloud hosting with seamless scalability, speed, and reliability</p>
                                <div class="card-plan__offer">
                                    <span class="past-price">$98.87</span>
                                    <span class="offer-given">Save 60%</span>
                                </div>
                                <h5 class="card-plan__price">
                                    <sup>$</sup> 98.87 <sub>/ month</sub>
                                </h5>
                                <div class="card-plan__cartbtn">
                                    <a href="https://my.wefithost.com/manage">Sign Up Now</a>
                                </div>
                                <p class="card-plan__renew-price">
                                    $ 192.75 /mo when you renew
                                </p>
                                <div class="card-plan__feature">
                                    <ul class="card-plan__feature--list">
                                        <li class="card-plan__feature--list-item">
                        ...
                        <div class="priority-content" data-sal="slide-down" data-sal-delay="300" data-sal-duration="800">
                            <div class="single-priority">
                                ...
                                <div class="content">
                                    ...
                                    <p class="mb-0">Get fast-tracked assistance from WeFitHost’s expert team, ensuring your issues are resolved quickly and efficiently.</p>
                                </div>
                            </div>
                            <div class="single-priority">
                                <div class="icon">
                                ...
                                <div class="content">
                                    <h5>Unparalleled Speed</h5>
                                    <p class="mb-0"> Experience lightning-fast performance with WeFitHost’s optimized servers, ensuring your website loads instantl</p>
                                </div>
                            </div>
                            <div class="single-priority">
                                <div class="icon">
                                ...
                                <div class="content">
                                    ...
                                    <p class="mb-0"> WeFitHost delivers blazing-fast speeds with cutting-edge technology to keep your website performing at its best</p>
                                </div>
                            </div>
                            <div class="single-priority">
                                <div class="icon">
                                ...
                                <div class="content">
                                    <h5>A Cloud That Grows With You</h5>
                                    <p class="mb-0">WeFitHost’s scalable cloud solutions adapt to your needs, ensuring seamless growth and performance</p>
                                </div>
                            </div>
