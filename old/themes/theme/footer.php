  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>WeFitHost</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        Designed by Ayomide Hassan
      </div>
    </div>
  </footer><!-- End Footer -->
...
<!-- Hero Section Button -->
<a href="#" id="getStartedBtn1" class="btn-get-started">Get Started</a>

<script>
  document.addEventListener('DOMContentLoaded', () => {
    const modal = document.getElementById('authModal');
    const getStartedBtn = document.getElementById('getStartedBtn1');
